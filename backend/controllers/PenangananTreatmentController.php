...
use backend\models\PenangananTreatmentSearch;
...
/**
 * PenangananTreatmentController implements the CRUD actions for PenangananTreatment model.
 */
class PenangananTreatmentController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all PenangananTreatment models.
     * @return mixed
     */
    public function actionIndex($id_penanganan = null)
    {
        $request = Yii::$app->request;
        $searchModel = new PenangananTreatmentSearch();
    ...
    /**
     * Displays a single PenangananTreatment model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new PenangananTreatment model.
    ...
    public function actionCreate($id_penanganan)
    {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => "Tambah Penanganan Treatment",
                ...
                $model->harga = $model->treatment->harga;
                $model->save();
                return [
    ...
    /**
     * Updates an existing PenangananTreatment model.
     * For ajax request will return json object
    ...
    public function actionUpdate($id)
    {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                return [
                    'title' => "Ubah Penanganan Treatment",
    ...
    /**
     * Delete an existing PenangananTreatment model.
     * For ajax request will return json object
    ...
    /**
     * Finds the PenangananTreatment model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PenangananTreatment the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
                if (($model = PenangananTreatment::findOne($id)) !== null) {
            return $model;
        } else {
