...
/**
 * RiwayatMedisPasienSearch represents the model behind the search form about `common\models\RiwayatMedisPasien`.
 */
class RiwayatMedisPasienSearch extends RiwayatMedisPasien
{
    public $cari;
    /**
     * @inheritdoc
    ...
    {
        return [
            [['id', 'id_pasien', 'meriang', 'sakit_kepala', 'batuk', 'diare', 'nyeri_otot', 'mual', 'endemik', 'demam', 'keringat_dingin', 'dehidrasi', 'hasil', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            ['cari', 'safe'],
        ];
    }
