...
<div class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li><span class="dropdown-item hidecolumn" data-column="1">
            <input type="checkbox" id = "1"> <label for = "1">Id Penanganan</label>
        </span></li>
        ...
        <li><span class="dropdown-item hidecolumn" data-column="5">
            <input type="checkbox" id = "5"> <label for = "5">Harga</label>
        </span></li>
        <li><span class="dropdown-item hidecolumn" data-column="6">
            <input type="checkbox" id = "6"> <label for = "6">Harga Total</label>
        </span></li>    </ul>
</div>