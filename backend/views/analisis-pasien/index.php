...
/* @var $searchModel backend\models\AnalisisPasienSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Analisis Pasiens';
...
<div class="analisis-pasien-index">
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="m-0 text-dark">Analisis Pasien</h5>
                </div>
                <div>
                    <?=
                        Html::a(
                            ...
                            ['create'],
                            ['data-pjax' => 0 , 'title' => 'Tambah Analisis Pasien', 'class' => 'btn btn-outline-primary btn-border']
                        )
                    ?>
                </div>
            </div>
