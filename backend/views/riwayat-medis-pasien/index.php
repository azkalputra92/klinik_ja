...
/* @var $searchModel backend\models\RiwayatMedisPasienSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Riwayat Medis Pasiens';
...
<div class="riwayat-medis-pasien-index">
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="m-0 text-dark">Riwayat Medis Pasien</h5>
                </div>
                <div>
                    <?=
                        Html::a(
                            ...
                            ['create'],
                            ['role' => 'modal-remote', 'title' => 'Tambah Riwayat Medis Pasien', 'class' => 'btn btn-outline-primary btn-border']
                        )
                    ?>
                </div>
            </div>
