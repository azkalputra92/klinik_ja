...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    'panelHeadingTemplate' => '<div class="d-flex justify-content-between w-100">
        <div class="d-flex align-items-center">
            <h5 class="fw-normal mb-2 mb-md-0 fw-500 fs-16">Semua Treatment</h5>
        </div>
        ...
        <div class="d-flex justify-content-start justify-content-md-end align-items-center">'.
            ...
            'Tambah Treatment',
            ['create'],
            ['role' => 'modal-remote', 'title' => 'Tambah Treatment', 'class' => 'btn btn btn-primary', 'style' => 'width: fit-content;']
            ).'
        </div>
    </div>',
    'panel' => [
